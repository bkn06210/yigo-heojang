 ...
 * <p>
 * PERF_SHORTAGE / BENEFIT_LIMIT      : 후보 1건당 만들어지는 개별 알림
 * PERF_SHORTAGE_DIGEST / BENEFIT_LIMIT_DIGEST : 후보가 3건을 초과할 때의 다이제스트 알림
 * <p>
 * 실적 부족과 혜택 한도는 알림 규칙 문서(4장)에 따라 서로 섞이지 않으므로
