 ...
 *
 * {@code @NoArgsConstructor} : 인자 없는 생성자. 프레임워크(MyBatis, Jackson 등)가
...
public class Notification {
    ...
    // 개별 알림이면 값이 있고, 다이제스트 알림이면 NULL로 저장한다.
    ...
    // PERFORMANCE_SHORTAGE:{userCardId}:MONTH:{yearMonth}:D7 같은 형태의 중복 방지 키.
